...
The ridge model provided the best combined R-squared and RMSE values and the top 5 predictors of water quality from this model are interpreted as follows:

For a 1 unit increase in:              The median total dissolved solids is expected to increase by:

LatitudeDD                   1.834
LongitudeDD                  0.752
LandSurfaceElevation         0.996
MeanWaterLvl                 0.996
WellDepth                    0.998

### Water Sources with elevated total dissolved solids    

Source:                      Median increase in total dissolved solids:

WellUseDomestic              0.969%
WellUseIndustrial            0.752%
WellUseInstitution           0.857%
WellUseIrrigation            1.040%
WellUsePlugged or Destroyed  1.089%
WellUsePower                 1.303%
WellUsePublic Supply         0.957%
WellUseRecreation            1.658%
WellUseUnused                0.962%
...
We identified the top 14 features that predict the median measurements of total dissolved solids in Lubbock County. The top predictor of total dissolved solids in Lubbock County is latitude. Every unit increase in latitude in Lubbock County is associated with a 1.834% increase in the median TDS value.It is important to note that increases in total dissolved solids are indicators of reduced water quality, so the predictors identified help us quantify the 14 greatest indicators of poor water quality in Lubbock County.

With each unit increase in latitude, total dissolvied solids increases 1.834%. Residents of northern Lubbock County can expect poorer water quality, unless they draw their water from a well correlated with higher quality water, such as the listed industrial water supplies. The top predictor from well usage categories were wells used for power sources, which on average increased the median total dissolved solids measurements by 1.303%. 
